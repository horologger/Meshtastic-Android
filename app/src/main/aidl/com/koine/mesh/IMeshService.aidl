// com.koine.mesh.IMeshService.aidl
...
<queries>
    <package android:name="com.koine.mesh" />
</queries>
...
Once you have bound to the service you should register your broadcast receivers per https://developer.android.com/guide/components/broadcasts#context-registered-receivers
    ...
    // com.koine.mesh.x broadcast intents, where x is:
    ...
    // (i.e. com.koine.mesh.RECEIVED.TEXT_MESSAGE_APP) else the numeric portnum will be included as a base 10 integer (com.koine.mesh.RECEIVED.4403 etc...)
