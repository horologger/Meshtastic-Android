...
import com.koine.mesh.android.BindFailedException
import com.koine.mesh.android.GeeksvilleApplication
import com.koine.mesh.android.Logging
import com.koine.mesh.android.ServiceClient
import com.koine.mesh.android.dpToPx
import com.koine.mesh.android.getBluetoothPermissions
import com.koine.mesh.android.getNotificationPermissions
import com.koine.mesh.android.hasBluetoothPermission
import com.koine.mesh.android.hasNotificationPermission
import com.koine.mesh.android.permissionMissing
import com.koine.mesh.android.rationaleDialog
import com.koine.mesh.android.shouldShowRequestPermissionRationale
import com.koine.mesh.concurrent.handledLaunch
import com.koine.mesh.databinding.ActivityMainBinding
import com.koine.mesh.model.BluetoothViewModel
...
import com.koine.mesh.service.MeshServiceNotifications
import com.koine.mesh.service.ServiceRepository
import com.koine.mesh.service.startService
import com.koine.mesh.ui.ChannelFragment
import com.koine.mesh.ui.ContactsFragment
import com.koine.mesh.ui.DebugFragment
import com.koine.mesh.ui.QuickChatSettingsFragment
import com.koine.mesh.ui.SettingsFragment
import com.koine.mesh.ui.UsersFragment
import com.koine.mesh.ui.components.ScannedQrCodeDialog
import com.koine.mesh.ui.map.MapFragment
import com.koine.mesh.ui.message.navigateToMessages
import com.koine.mesh.ui.navigateToShareMessage
import com.koine.mesh.ui.theme.AppTheme
import com.koine.mesh.util.Exceptions
import com.koine.mesh.util.LanguageUtils
import com.koine.mesh.util.getPackageInfoCompat
