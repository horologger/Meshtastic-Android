...
import com.koine.mesh.AdminProtos
import com.koine.mesh.AppOnlyProtos
import com.koine.mesh.BuildConfig
import com.koine.mesh.ChannelProtos
import com.koine.mesh.ConfigProtos
import com.koine.mesh.CoroutineDispatchers
import com.koine.mesh.DataPacket
import com.koine.mesh.IMeshService
import com.koine.mesh.LocalOnlyProtos.LocalConfig
import com.koine.mesh.LocalOnlyProtos.LocalModuleConfig
import com.koine.mesh.MeshProtos
import com.koine.mesh.MeshProtos.MeshPacket
import com.koine.mesh.MeshProtos.ToRadio
import com.koine.mesh.MeshUser
import com.koine.mesh.MessageStatus
import com.koine.mesh.ModuleConfigProtos
import com.koine.mesh.MyNodeInfo
import com.koine.mesh.NodeInfo
import com.koine.mesh.PaxcountProtos
import com.koine.mesh.Portnums
import com.koine.mesh.Position
import com.koine.mesh.R
import com.koine.mesh.StoreAndForwardProtos
import com.koine.mesh.TelemetryProtos
import com.koine.mesh.TelemetryProtos.LocalStats
import com.koine.mesh.analytics.DataPair
import com.koine.mesh.android.GeeksvilleApplication
import com.koine.mesh.android.Logging
import com.koine.mesh.android.hasLocationPermission
import com.koine.mesh.concurrent.handledLaunch
import com.koine.mesh.config
import com.koine.mesh.copy
import com.koine.mesh.database.MeshLogRepository
import com.koine.mesh.database.PacketRepository
import com.koine.mesh.database.entity.MeshLog
import com.koine.mesh.database.entity.MyNodeEntity
import com.koine.mesh.database.entity.NodeEntity
import com.koine.mesh.database.entity.Packet
import com.koine.mesh.database.entity.ReactionEntity
import com.koine.mesh.fromRadio
import com.koine.mesh.model.DeviceVersion
import com.koine.mesh.model.Node
import com.koine.mesh.model.getTracerouteResponse
import com.koine.mesh.position
import com.koine.mesh.repository.datastore.RadioConfigRepository
import com.koine.mesh.repository.location.LocationRepository
import com.koine.mesh.repository.network.MQTTRepository
import com.koine.mesh.repository.radio.RadioInterfaceService
import com.koine.mesh.repository.radio.RadioServiceConnectionState
import com.koine.mesh.telemetry
import com.koine.mesh.user
import com.koine.mesh.util.anonymize
import com.koine.mesh.util.toOneLineString
import com.koine.mesh.util.toPIIString
import com.koine.mesh.util.toRemoteExceptions
...
class MeshService : Service(), Logging {
    ...
    companion object : Logging {
        ...
        fun createIntent() = Intent().setClassName(
            "com.koine.mesh",
            "com.koine.mesh.service.MeshService"
        )
