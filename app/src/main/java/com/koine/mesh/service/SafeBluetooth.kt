...
import com.koine.mesh.concurrent.CallbackContinuation
import com.koine.mesh.concurrent.Continuation
import com.koine.mesh.concurrent.SyncContinuation
import com.koine.mesh.android.bluetoothManager
import com.koine.mesh.util.exceptionReporter
...
class SafeBluetooth(private val context: Context, private val device: BluetoothDevice) :
    ...
    private class BluetoothContinuation(
        val tag: String,
        val completion: com.koine.mesh.concurrent.Continuation<*>,
     ...
     * 06-29 08:47:15.035 29788-30155/com.koine.mesh D/BluetoothGatt: cancelOpen() - device: 24:62:AB:F8:40:9A
    06-29 08:47:15.036 29788-30155/com.koine.mesh D/BluetoothGatt: close()
    06-29 08:47:15.037 29788-30155/com.koine.mesh D/BluetoothGatt: unregisterApp() - mClientIf=5
    06-29 08:47:15.037 29788-29813/com.koine.mesh D/BluetoothGatt: onClientConnectionState() - status=0 clientIf=5 device=24:62:AB:F8:40:9A
    06-29 08:47:15.037 29788-29813/com.koine.mesh W/BluetoothGatt: Unhandled exception in callback
    ...
    fun closeGatt() {
        ...
        gatt?.let { g ->
            ...
            try {
                ...
                //com.koine.mesh.service.SafeBluetooth.closeGatt
