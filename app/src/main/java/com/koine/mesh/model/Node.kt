...
import com.koine.mesh.ConfigProtos.Config.DisplayConfig
import com.koine.mesh.MeshProtos
import com.koine.mesh.PaxcountProtos
import com.koine.mesh.TelemetryProtos.DeviceMetrics
import com.koine.mesh.TelemetryProtos.EnvironmentMetrics
import com.koine.mesh.TelemetryProtos.PowerMetrics
import com.koine.mesh.database.entity.NodeEntity
import com.koine.mesh.util.GPSFormat
import com.koine.mesh.util.latLongToMeter
import com.koine.mesh.util.toDistanceString
...
data class Node(
    ...
    fun bearing(o: Node?): Int? = when {
        validPosition == null || o?.validPosition == null -> null
        else -> com.koine.mesh.util.bearing(latitude, longitude, o.latitude, o.longitude).toInt()
    }
